              ...
              onPressed: ()async{
                ...
                Geolocator geolocator = new Geolocator();
                  currentLocation = await Geolocator.getCurrentPosition(
                    ...
                    print("Printing location of user");
                    print("Latitude :" +currentLocation.latitude.toString());
                    print("Latitude :" +currentLocation.longitude.toString());
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>LocationChanger()));
              },
              icon: Icon(Icons.location_on_rounded, color: Colors.purple), 
