...
class BusinessFlashSale extends StatefulWidget {
  @override
  BusinessFlashSaleState createState() => BusinessFlashSaleState();
}

class BusinessFlashSaleState extends State<BusinessFlashSale> {
  var data;
  List<String> dummy;
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull("https://food-swap.herokuapp.com/menu/BusinessFlashSale"),
