...
import 'package:swap/Screens/Payment.dart';
...
class _CheckRazorState extends State<CheckRazor> {
  ...
  void initState() {
    ...
    options = {
      'key': "rzp_test_1ns0ChyiK9yBT1", // Enter the Key ID generated from the Dashboard
      ...
      'theme.color': "#008BFF",
      'buttontext': "Razorpay",
      'description': 'Proceed with your safe payment',
      'prefill': {
        'contact': '6049920346',
        'email': 'lakshman.team2020@gmail.com',
      }
    };
  }
