...
class scrolldonation extends StatefulWidget {
  const scrolldonation({
    Key key,
    this.scrollController,
  }):super(key:key);
  final ScrollController scrollController;
  @override
  _scrolldonationState createState() => _scrolldonationState();
}

class _scrolldonationState extends State<scrolldonation> {
  @override
                      ...
                      Container(
                        ...
                        child:Row(
                          children: [
                            ...
                            Text("Pickup",style: TextStyle(color: Colors.blue),),
                          ],
                        ),
                      ),
                      Container( child:Row(
